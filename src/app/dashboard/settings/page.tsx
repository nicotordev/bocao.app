  ...
  return {
    ...
    sections: {
      ...
      hours: {
        ...
        tableCapacityFromFloorPlan: t("sections.hours.tableCapacityFromFloorPlan"),
      ...
      billing: {
        ...
        currentPlan: t("sections.billing.currentPlan"),
        plans: {
          starter: t("sections.billing.plans.starter"),
          growth: t("sections.billing.plans.growth"),
          enterprise: t("sections.billing.plans.enterprise"),
        },
        usage: {
          whatsapp: t("sections.billing.usage.whatsapp"),
          aiCredits: t("sections.billing.usage.aiCredits"),
          reservations: t("sections.billing.usage.reservations"),
        },
        managePlan: t("sections.billing.managePlan"),
        viewHistory: t("sections.billing.viewHistory"),
        mockHint: t("sections.billing.mockHint"),
      },
      appearance: {
      ...
      security: {
        ...
        sessionsHint: t("sections.security.sessionsHint"),
