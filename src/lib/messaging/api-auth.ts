...
export async function requireRestaurantWhatsAppAccess(restaurantId: string) {
...
export async function requireRestaurantWhatsAppWriteAccess(restaurantId: string) {
