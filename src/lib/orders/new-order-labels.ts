...
export async function getNewOrderLabels(): Promise<NewOrderLabels> {
  ...
  return {
    ...
    table: {
      ...
      expandPicker: t("table.expandPicker"),
      pickerDialogTitle: t("table.pickerDialogTitle"),
      pickerDialogDescription: t("table.pickerDialogDescription"),
      floor: t("table.floor"),
      floorUp: t("table.floorUp"),
