      ...
      >
        {customer ? (
          ...
          <SheetHeader className="sr-only">
            <SheetTitle>{labels.drawer.title}</SheetTitle>
            <SheetDescription>{labels.drawer.description}</SheetDescription>
          </SheetHeader>
        )}
          ...
          <div className="space-y-6 px-6 pb-8">
            <section className="rounded-3xl border border-border bg-card p-4">
              <h3 className="font-heading font-medium">
                {labels.drawer.profile}
              </h3>
              <div className="mt-4 space-y-3">
                <DetailRow
                  label={labels.drawer.phone}
                  value={customer.phone ?? "—"}
                />
                <DetailRow
                  label={labels.drawer.email}
            ...
            <section className="rounded-3xl border border-border bg-card p-4">
              ...
              <div className="mt-4 space-y-4 text-sm">
                ...
                <div>
                  ...
                  <p className="mt-2">
                    {customer.notes ?? labels.drawer.noNotes}
                  </p>
                </div>
                <div>
                  <p className="text-muted-foreground">
                    {labels.drawer.allergies}
                  </p>
                  <p className="mt-2">
                      ...
                      >
                        <div className="flex items-center justify-between gap-3">
                          <p className="font-medium">
                            ...
                            {labels.drawer.reservations.toLowerCase()}
                          </p>
                          <p className="text-xs text-muted-foreground">
                            {reservation.status}
                          </p>
