  ...
  return (
    ...
    >
      <SidebarHeader className="gap-3.5 p-3.5">
        <Link
          href="/dashboard"
          className="flex items-center gap-2.5 rounded-xl px-2 py-1.5 transition-all duration-200 hover:bg-sidebar-accent/50 group"
        >
          <span className="flex size-8 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-emerald-600 text-primary-foreground shadow-sm transition-transform duration-200 group-hover:scale-105 group-hover:rotate-3">
